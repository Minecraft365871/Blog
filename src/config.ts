...
export const siteConfig: SiteConfig = {
	title: "365の部屋",
	subtitle: "一つのブログ",
	siteURL: "https://minecraft-365871.rian.cloud/", // 请替换为你的站点URL，以斜杠结尾
	...
	bilibili: {
		vmid: "3494374381979891", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	banner: {
		...
		src: {
			desktop: [
				"/assets/desktop-banner/109986410.webp",
			], // 桌面横幅图片
			mobile: [
		...
		credit: {
			...
			text: "kyl490", // 要显示的来源文本
			url: "https://www.pixiv.net/artworks/109986410", // （可选）原始艺术品或艺术家页面的 URL 链接
		},
...
export const fullscreenWallpaperConfig: FullscreenWallpaperConfig = {
	...
	position: "bottom", // 壁纸位置，等同于 object-position
	carousel: {
		enable: true, // 启用轮播
		interval: 5, // 轮播间隔时间（秒）
	},
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				...
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/3494374381979891",
					external: true,
					icon: "fa7-brands:bilibili",
				},
				{
					name: "X",
					url: "https://x.com/Minecraft365871",
					external: true,
...
export const profileConfig: ProfileConfig = {
	...
	name: "Minecraft_365871",
	bio: "ISFP-T | 简繁中文 | 大小写敏感 | 深色模式享受者 | 互联网泔水爱好者 | 编程只会Hello world | 作业永远写不完",
	typewriter: {
...
export const permalinkConfig: PermalinkConfig = {
	 ...
	 * 注意：支持使用斜杠 "/" 构建嵌套路径。
	 */
	format: "%postname%-|-%category%-|-%post_id%-|-%year%", // 默认使用文件名
};
...
export const announcementConfig: AnnouncementConfig = {
	...
	link: {
		enable: true, // 启用链接
		text: "去玩", // 链接文本
		url: "https://eat-shiroko.pages.dev", // 链接 URL
		external: false, // 内部链接
	},
};
